...
estimadores_buenos = CSV.read("D:/Edgar Trejo/Universidad/Proyecto/StochasticSISModel/data/samples/sample_4_2_2.csv",
DataFrame)
...
bottom_margin = 5Plots.mm, right_margin = 5Plots.mm, topmargin = 5Plots.mm)

result_plot = plot(plot_sims, plot_qq, layout = @layout([a{0.66w} b{0.34w}]), size = (800, 300), dpi = 200,
plot_title = "Estimación con verosimilitud simulada", plot_titlefont = 12)

savefig(result_plot, "D:/Edgar Trejo/Universidad/Proyecto/StochasticSISModel/data/images/plot_4_2_2.png")
# prueba estadística
